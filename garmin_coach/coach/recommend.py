...
def recommend(goal: str | None = None, provider=None, model: str | None = None) -> dict:
    ...
    prompt = (
        ...
        "Assess this athlete's current state and give AT MOST 3 prioritised, "
        "cited recommendations — only the few that matter most right now, not an "
        "exhaustive list. Ground every point in their actual numbers above, and "
